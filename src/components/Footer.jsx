        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a
                href="https://www.google.com/maps/search/?api=1&query=Av.+Independência,+3160,+Piracicaba"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 text-white transition-colors duration-200 hover:text-white/80"
              >
